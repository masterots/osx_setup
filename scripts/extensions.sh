...
install_git_app "$MOVE_TAB_FILE_EXTENSION_URL" "$MOVE_TAB_FILE_EXTENSION_PATH"

# Sublime Text 2 - Apply Syntax
install_git_app "$APPLY_SYNTAX_FILE_EXTENSION_URL" "$APPLY_SYNTAX_FILE_EXTENSION_PATH"
