...
export DROPBOX_APP_FILE=Dropbox%202.0.16.dmg
...
export ALFRED_APP_FILE=Alfred_2.0.4_199.zip
...
export SOURCE_TREE_APP_FILE=SourceTree_1.6.0.1.dmg
export SOURCE_TREE_APP_NAME=SourceTree.app

export GITHUB_APP_URL=https://github-central.s3.amazonaws.com
export GITHUB_APP_FILE=mac%2FGitHub%20for%20Mac%20147.zip
...
export SKYPE_APP_FILE=Skype_6.5.0.443.dmg
