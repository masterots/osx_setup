...
export MOVE_TAB_FILE_EXTENSION_URL="git://github.com/SublimeText/MoveTab.git"
export MOVE_TAB_FILE_EXTENSION_PATH="$SUBLIME_TEXT_EXTENSION_ROOT/MoveTab"
export APPLY_SYNTAX_FILE_EXTENSION_URL="git://github.com/facelessuser/ApplySyntax.git"
export APPLY_SYNTAX_FILE_EXTENSION_PATH="$SUBLIME_TEXT_EXTENSION_ROOT/ApplySyntax"
export CHANGE_QUOTES_FILE_EXTENSION_URL="git://github.com/colinta/SublimeChangeQuotes.git"
export CHANGE_QUOTES_FILE_EXTENSION_PATH="$SUBLIME_TEXT_EXTENSION_ROOT/ChangeQuotes"
export BRACKET_HIGHLIGHTER_FILE_EXTENSION_URL="git://github.com/facelessuser/BracketHighlighter.git"
export BRACKET_HIGHLIGHTER_FILE_EXTENSION_PATH="$SUBLIME_TEXT_EXTENSION_ROOT/BracketHighlighter"
export TRAILING_SPACES_FILE_EXTENSION_URL="git://github.com/SublimeText/TrailingSpaces.git"
export TRAILING_SPACES_FILE_EXTENSION_PATH="$SUBLIME_TEXT_EXTENSION_ROOT/TrailingSpaces"
export COLOR_HIGHLIGHTER_FILE_EXTENSION_URL="git://github.com/Monnoroch/ColorHighlighter.git"
export COLOR_HIGHLIGHTER_FILE_EXTENSION_PATH="$SUBLIME_TEXT_EXTENSION_ROOT/ColorHighlighter"
...
export SOURCE_TREE_APP_FILE=SourceTree_1.5.8.dmg
...
export HAZEL_APP_FILE=Hazel-3.0.18.dmg
