...
export ALFRED_APP_FILE=Alfred_2.2_243b.zip
...
export FIREFOX_APP_URL=https://download-installer.cdn.mozilla.net/pub/firefox/releases/29.0/mac/en-US
...
export VLC_APP_URL=https://get.videolan.org/vlc/2.1.4/macosx
...
export OPEN_OFFICE_APP_URL=http://hivelocity.dl.sourceforge.net/project/openofficeorg.mirror/4.1.0/binaries/en-US
