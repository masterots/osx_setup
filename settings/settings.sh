...
export ITERM_APP_FILE=iTerm2_v2_0.zip
export ITERM_APP_URL="http://iterm2.com/downloads/stable/$ITERM_APP_FILE"
...
export TRANSMIT_APP_FILE=Transmit%204.4.8.zip
...
export CLOAK_APP_FILE=Cloak-2.0.8.dmg
